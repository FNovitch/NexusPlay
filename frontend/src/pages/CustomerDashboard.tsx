  ...
  return (
    <main className="app-shell section-y">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-semibold leading-tight text-nexus-contrast">Minha conta</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Link to="/cliente" className="panel p-5 transition duration-200 hover:-translate-y-0.5 hover:border-nexus-metal hover:shadow-card"><UserRound className="mb-3 h-5 w-5 text-nexus-primary" /><strong>Perfil</strong><p className="text-sm text-nexus-muted">Dados da conta.</p></Link>
      </div>
