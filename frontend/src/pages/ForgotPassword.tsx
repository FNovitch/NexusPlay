  ...
  return (
    <main className="app-shell grid min-h-[68vh] place-items-center py-12">
      <form onSubmit={submit} className="panel w-full max-w-md p-6">
        ...
        <h1 className="text-3xl font-black tracking-tight text-kriar-contrast">Esqueci minha senha</h1>
        <p className="mt-3 text-sm leading-6 text-kriar-muted">Informe o e-mail da sua conta para receber um link de recuperacao.</p>
        ...
        <Link to="/cliente/login" className="mt-4 block text-center text-sm font-bold text-kriar-primary">Voltar para o login de cliente</Link>
      </form>
    </main>
  );
}
